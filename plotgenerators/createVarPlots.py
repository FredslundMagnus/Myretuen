    ...
    try:
        ...
        try:
            if Elo is not None:
                ...
                plt.axhline(y=1000, color='r', lw=2, label='RandomAgent')
                plt.axhline(y=1200, color='black', linestyle='dashed', lw=1)
                plt.axhline(y=1400, color='black', linestyle='dashed', lw=1)
                plt.axhline(y=1600, color='black', linestyle='dashed', lw=1)
                plt.axhline(y=1800, color='black', linestyle='dashed', lw=1)
                plt.axhline(y=2000, color='black', linestyle='dashed', lw=1)
                plt.axhline(y=2200, color='black', linestyle='dashed', lw=1)
                plt.axhline(y=2400, color='black', linestyle='dashed', lw=1)
