...
for selfplay in [20, 50, 100]:
    ...
    l = [(f'NN-Selfplay-{selfplay}-weighted', 'Weighted Chooser', '#9C27B0'), (f'NN-Selfplay-{selfplay}-random', 'Random Chooser', '#2196F3'), (f'NN-Selfplay-{selfplay}-incremental', 'Incremental Chooser', '#4CAF50')]
