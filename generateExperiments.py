...
genExperiments('6000-memory', 'NNAgent', 6000, 20, True, False, True, True, False, lossf='MME', discount=0.995, lambd=0.9, lr=0.0001, dropout=0.5, K=2000, batchSize=20, historyLength=10, startAfterNgames=10, sampleLenth=10, chooserfunction='weightedChooser')
genExperiments('5000-memory', 'NNAgent', 5000, 20, True, False, True, True, False, lossf='MME', discount=0.995, lambd=0.9, lr=0.0001, dropout=0.5, K=2000, batchSize=20, historyLength=10, startAfterNgames=10, sampleLenth=10, chooserfunction='weightedChooser')
genExperiments('4000-memory', 'NNAgent', 4000, 20, True, False, True, True, False, lossf='MME', discount=0.995, lambd=0.9, lr=0.0001, dropout=0.5, K=2000, batchSize=20, historyLength=10, startAfterNgames=10, sampleLenth=10, chooserfunction='weightedChooser')
genExperiments('3000-memory', 'NNAgent', 3000, 20, True, False, True, True, False, lossf='MME', discount=0.995, lambd=0.9, lr=0.0001, dropout=0.5, K=2000, batchSize=20, historyLength=10, startAfterNgames=10, sampleLenth=10, chooserfunction='weightedChooser')
