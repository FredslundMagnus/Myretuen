...
genExperiments('MinMax-off', 'NNAgent', 500, 10, False, True, True, True, False, 10)
# genExperiments('NoExplore', 'NNAgent', 1000, 10, False, True, True, True, True, 10)
# genExperiments('NoImpala2', 'NNAgent', 2000, 10, True, True, False, True, True, 10)
# genExperiments('NoProbs', 'NNAgent', 1000, 10, True, True, True, False, True, 10)
