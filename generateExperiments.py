...
genExperiments('NODROPOUT6000-memoryENDREWARD40', 'NNAgent', 6000, 20, True, False, True, True, False, lossf='MME', discount=0.995, lambd=0.9, lr=0.0001, dropout=0, K=2000, batchSize=20, historyLength=10, startAfterNgames=10, sampleLenth=10, chooserfunction='weightedChooser')
genExperiments('NODROPOUT60005000-memoryENDREWARD40', 'NNAgent', 5000, 20, True, False, True, True, False, lossf='MME', discount=0.995, lambd=0.9, lr=0.0001, dropout=0, K=2000, batchSize=20, historyLength=10, startAfterNgames=10, sampleLenth=10, chooserfunction='weightedChooser')
genExperiments('NODROPOUT60004000-memoryENDREWARD40', 'NNAgent', 4000, 20, True, False, True, True, False, lossf='MME', discount=0.995, lambd=0.9, lr=0.0001, dropout=0, K=2000, batchSize=20, historyLength=10, startAfterNgames=10, sampleLenth=10, chooserfunction='weightedChooser')
genExperiments('NODROPOUT60003000-memoryENDREWARD40', 'NNAgent', 3000, 20, True, False, True, True, False, lossf='MME', discount=0.995, lambd=0.9, lr=0.0001, dropout=0, K=2000, batchSize=20, historyLength=10, startAfterNgames=10, sampleLenth=10, chooserfunction='weightedChooser')
