...
genExperiments('testing', 'NNAgent', 30, 5, True, True, True, True, False, n=5, K=2000, lossf='MME', discount=0.995, lambd=0.9, lr=0.0002, network='[70,60,50,40,30,20,10]', winNumber=5, maxRolls=500, Eatreward=10, basereward=10, stepreward=-1)
