...
def genExperiments(name, agent, gameLength, adAgent, explore, doTrain, impala, calcprobs, minmax, n, lossf=None, K=None, dropout=None, alpha=None, discount=None, lambd=None, lr=None, chooserfunction=None, TopNvalues=None, cutOffdepth=None, ValueCutOff=None, ValueDiffCutOff=None, ProbabilityCutOff=None):
