...
genExperiments('TEST12', 'NNAgent', 5, 10, True, False, True, True, False, n=5, K=1000, lossf='MME', discount=0.98, lambd=0.8, lr=0.0001, winNumber=9, maxRolls=300, Eatreward=4, basereward=4, stepreward=0, chooserfunction='weightedChooser', historyLength=2, startAfterNgames=2, batchSize=100, sampleLenth=10, network=[50,25,10])
