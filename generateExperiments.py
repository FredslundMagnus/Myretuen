...
genExperiments('NN-Selfplay-20-random', 'NNAgent', 4000, 20, False, True, False, False, False, lossf='MSE', discount=0.95, lambd=0, lr=0.0002, chooserfunction='randomChooser')
genExperiments('NN-Selfplay-50-random', 'NNAgent', 4000, 50, False, True, False, False, False, lossf='MSE', discount=0.95, lambd=0, lr=0.0002, chooserfunction='randomChooser')
genExperiments('NN-Selfplay-100-random', 'NNAgent', 4000, 100, False, True, False, False, False, lossf='MSE', discount=0.95, lambd=0, lr=0.0002, chooserfunction='randomChooser')

genExperiments('NN-Selfplay-20-incremental', 'NNAgent', 4000, 20, False, True, False, False, False, lossf='MSE', discount=0.95, lambd=0, lr=0.0002, chooserfunction='incrementalChooser')
genExperiments('NN-Selfplay-50-incremental', 'NNAgent', 4000, 50, False, True, False, False, False, lossf='MSE', discount=0.95, lambd=0, lr=0.0002, chooserfunction='incrementalChooser')
genExperiments('NN-Selfplay-100-incremental', 'NNAgent', 4000, 100, False, True, False, False, False, lossf='MSE', discount=0.95, lambd=0, lr=0.0002, chooserfunction='incrementalChooser')

genExperiments('NN-Selfplay-20-weighted', 'NNAgent', 4000, 20, False, True, False, False, False, lossf='MSE', discount=0.95, lambd=0, lr=0.0002, chooserfunction='weightedChooser')
genExperiments('NN-Selfplay-50-weighted', 'NNAgent', 4000, 50, False, True, False, False, False, lossf='MSE', discount=0.95, lambd=0, lr=0.0002, chooserfunction='weightedChooser')
genExperiments('NN-Selfplay-100-weighted', 'NNAgent', 4000, 100, False, True, False, False, False, lossf='MSE', discount=0.95, lambd=0, lr=0.0002, chooserfunction='weightedChooser')

# genExperiments('LA-discount-0.5-NoTrain-alpha-0.0001', 'LinearAprox', 4000, 5000, False, True, False, False, False, alpha=0.0001, discount=0.5, lambd=0)
