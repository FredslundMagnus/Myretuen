...
if debuggerMode:
    ...
    controller = Controller(env=env, agent1=Opponent([CleverRandom(calcprobs=True), RandomAgent(), CleverRandom(calcprobs=False)]), agent2=NNAgent(explore=True, impala=True))
