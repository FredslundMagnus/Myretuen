...
if debuggerMode:
    ...
    env = Myretuen()
    controller = Controller(env=env, agent1=Opponent(RandomAgent()), agent2=NNAgent(explore=True, doTrain=False, impala=True, dropout=0.45, minmax=True, cutOffdepth=1, TopNvalues=4).loadModel('NNAgent2150ELO'))
