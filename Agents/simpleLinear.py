...
class SimpleLinear(Agent):
    def __init__(self, explore=True, doTrain=True, impala=True, calcprobs=True, minmax=True):
        self.setup(explore, doTrain, impala, calcprobs, minmax, name='SimpleLinear')
