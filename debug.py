...
def getvals(args):
    d = {'-lossf': 'Abs', '-K': 2000, '-dropout': 0, '-alpha': 0.00001, '-discount': 0.9, '-lambda': 0.5, '-lr': 0.00005, '-chooserfunction': 'randomChooser', '-TopNvalues': 6, '-cutOffdepth': 1, '-ValueCutOff': 5, '-ValueDiffCutOff': 2, '-ProbabilityCutOff': 0.03, '-historyLength': 50, '-startAfterNgames': 20, '-batchSize': 20, '-sampleLenth': 5, '-network': [50, 25, 10], '-winNumber': 9, '-maxRolls': 300, '-Eatreward': 4, '-basereward': 4, '-stepreward': 0}
